...
SSE41_FILES = arch/x86/crc32_chorba_sse41.c
...
AVX2_VPCLMUL_FILES = arch/x86/crc32_vpclmulqdq_avx2.c

AVX512_VPCLMUL_FILES = arch/x86/crc32_vpclmulqdq_avx512.c
endif
...
$(patsubst %.c,$(OBJ_DIR)/%.o,$(AVX2_VPCLMUL_FILES)): EXTRA_CFLAGS = -fno-lto -mpclmul -mvpclmulqdq
$(patsubst %.c,$(OBJ_DIR)/%.o,$(AVX512_VPCLMUL_FILES)): EXTRA_CFLAGS = -fno-lto -mpclmul -mavx512f -mvpclmulqdq -mavx512dq
endif
